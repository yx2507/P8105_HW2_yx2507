...
In precipitation data `data_rain`, there are `r nrow(data_raintot)` rows and `r ncol(data_raintot)`columns. Vraibles are month and the precipitation amount as "totoal"
